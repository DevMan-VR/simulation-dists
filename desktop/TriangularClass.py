...
from TriangularVA import pseudo_triangular

class TriangularClass:
    ...
    def renderFDP(self):
        ...
        triang = stats.triang(c=c)
        x = np.linspace(triang.ppf(0.01), triang.ppf(0.99), 100)
        fp = triang.pdf(x)
