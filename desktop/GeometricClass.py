...
from GeometricVA import pseudo_geometric

class GeometricClass:
    def __init__(self, master):
        self.master = master
        self.label1 = Label(master, text="n° pruebas", height=4)
    ...
    def renderFPA(self):
        ...
        x = np.arange(geometrica.ppf(0.01),
                    geometrica.ppf(0.99))
        fmp = geometrica.cdf(x) # Función de Masa de Probabilidad
